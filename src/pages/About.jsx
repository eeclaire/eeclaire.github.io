	...
	render() {
		return (
			<div className="text-content text-content-markdown">
				...
				<br/>
				<p>I recently completed the hackNY fellowship - a ten week internship program that matches students with NYC startups, houses them with other fellows, and provides tech talks from speakers such as Michael Pryor and Craig Newmark</p>
				<br/>
