	...
	render() {
		return (
			<div className="text-content text-content-markdown">
				<img className="medaillon" src="/src/img/brunch.jpg"/><p id="hullo">Hi there!</p>
				<p>My name is Claire Durand. I just graduated from Temple University in Philadelphia and as of this fall, I am a graduate student at Columbia University in New York. 
				...
				<br/>
				<p>As a thanks for reading this far, here's a gif in which I'm being goofy at PennApps</p>
